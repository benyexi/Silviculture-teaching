...
const SYNONYM_MAP: Record<string, string[]> = {
  ...
  // ── 效益与社会文化功能 ──
  '社会效益': ['社会文化效益', '社会功能', '社会价值', '社会效用', '社会效益表现形式'],
  '社会文化效益': ['社会效益', '文化效益', '社会功能', '社会价值'],
  '文化效益': ['社会文化效益', '社会效益', '文化功能', '生态文化'],
  '游憩价值': ['观赏价值', '观赏与游憩', '旅游与休闲', '休闲游憩'],
  '保健功能': ['康养功能', '健康功能', '森林保健', '康复保健'],
  '生态文化': ['生态文化与教育', '生态教育', '生态文明教育', '文化功能'],
  '就业机会': ['吸纳劳动力', '增加就业', '农村就业机会', '促进就业'],
  '增加农民收入': ['农民增收', '增收渠道', '提高农民收入'],
  '促进地方经济发展': ['促进区域发展', '农村社会经济发展', '地方社会经济发展'],
