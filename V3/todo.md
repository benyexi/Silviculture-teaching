...
- [x] 修复关键词提取 Bug：整个问题被当作单个关键词，改用 n-gram 分词算法
- [x] 切换到全文关键词检索方案（Forge API 不支持 Embedding）
- [x] 添加林业领域同义词扩展（造林密度↔林分密度等），提升检索召回率
- [x] 优化评分算法：长关键词指数级加权 + 短语匹配奖励
- [x] 25/25 测试全部通过（新增 5 个关键词提取测试）
